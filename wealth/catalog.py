...
# A fictional Mexican household for the quarterly review and fee audit (Q2 2026, prior quarter Q1).
_MX_OWNER = [{"person_id": "ana", "share": "1"}]
_MX_SOURCE = {"kind": "document", "ref": "estados de cuenta (fictional example)"}
