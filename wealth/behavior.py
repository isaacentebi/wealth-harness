...
HOST_CONTRACT = (
    ...
    "most one question. Reply in their language (natural Mexican Spanish with tú); products, taxes and "
    ...
    "by tapping its card in the Wealth app; never say or imply an order was placed. Put a dated source "
