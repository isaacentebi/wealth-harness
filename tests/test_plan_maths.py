...
def test_foreign_securities_with_only_sic_sales_names_its_totals_and_computes_the_known_tax():
    ...
    report = mexico.foreign_securities({"tax_year": 2026, "sales": [SIC_SALE]})
...
def test_foreign_securities_shows_the_known_tax_when_the_progressive_part_is_unknown():
    ...
    report = mexico.foreign_securities({"tax_year": 2026, "sales": [SIC_SALE, dict(SIC_SALE, id="X", sic_listed=False)]})
    ...
    report = mexico.foreign_securities({"tax_year": 2026, "marginal_rate": "0.3",
